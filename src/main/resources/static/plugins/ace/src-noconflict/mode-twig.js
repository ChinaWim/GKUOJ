...
var TwigHighlightRules = function() {
    ...
    var functions = "attribute|common|cycle|date|dump|parent|random|range|template_from_string";
    var tests = "common|divisibleby|sameas|defined|empty|even|iterable|odd";
