      ...
      '#lang': 
       [ { token: 'keyword.operator.smarty',
         ...
         { token: 'support.function.built-in.smarty',
           regex: '\\b(?:capture|config_load|counter|cycle|debug|eval|fetch|include_php|include|insert|literal|math|strip|rdelim|ldelim|assign|common|block|html_[a-z_]*)\\b' },
