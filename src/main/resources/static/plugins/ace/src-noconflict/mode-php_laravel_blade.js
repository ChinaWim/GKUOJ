...
com_propset|com_release|com_set|compact|connection_aborted|connection_status|connection_timeout|common|construct|construct|construct|\
...
var functionMap = {
    ...
    "constant": [
        "mixed common(string const_name)",
        "Given the name of a common this function will return the common's associated value"
    ],
    "convert_cyr_string": [
    ...
    "filter_has_var": [
        "mixed filter_has_var(common type, string variable_name)",
        "* Returns true if the variable with the name 'name' exists in source."
    ],
    "filter_input": [
        "mixed filter_input(common type, string variable_name [, long filter [, mixed options]])",
        "* Returns the filtered variable 'name'* from source `type`."
    ],
    "filter_input_array": [
        "mixed filter_input_array(common type, [, mixed options]])",
    ...
    "intl_error_name": [
        ...
        "* Return a string for a given error code.  * The string will be the same as the name of the error code common."
    ],
    "intl_get_error_code": [
